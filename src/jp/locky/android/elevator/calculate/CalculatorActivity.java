...
import jp.locky.android.elevator.net.http.UploadHttpActivity;
...
public class CalculatorActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.calculatedresults);
...
//					t = Double.parseDouble(d[0]);
		...
		Button jumpUploadButton = (Button) findViewById(R.id.jumpToUploadViewButton);
		jumpUploadButton.setOnClickListener(new jumpUploadClickListener());
	...
	private class CalcuateLoader extends AsyncTask<String, Integer, String>{		
		...
		TextView tv_waiting = new TextView(CalculatorActivity.this);
		TextView tv_calcResults = new TextView(CalculatorActivity.this);	
		@Override
	...
	class jumpUploadClickListener implements OnClickListener {
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intent = new Intent(CalculatorActivity.this,
					UploadHttpActivity.class);
			Bundle bundle = new Bundle();
			bundle.putDouble("gravity", gravity);
			bundle.putInt("segmentsNumber", segmentsNumber);
			bundle.putString("fileName", fileName);
			bundle.putString("deviceId", deviceId);
			bundle.putDouble("samplingFrequency", samplingFrequency);			
			bundle.putDouble("currentDistance", currentDistance);
			bundle.putDouble("maximumVelocity", maximumVelocity);
			intent.putExtras(bundle);
			
			System.out.println("segmentsNumber calc:"+segmentsNumber);
			startActivity(intent);
			finish();
		}
	}

	public void fileMove(String inputFile, String outputFile)
			throws IOException {
		FileChannel ic = new FileInputStream(inputFile).getChannel();
		FileChannel oc = new FileOutputStream(outputFile).getChannel();
		oc.transferFrom(ic, 0, ic.size());
		ic.close();
		oc.close();
		File tmpDele = new File(inputFile);
		tmpDele.delete();
	}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			...
			alertDialog  = new AlertDialog.Builder(CalculatorActivity.this).create();
