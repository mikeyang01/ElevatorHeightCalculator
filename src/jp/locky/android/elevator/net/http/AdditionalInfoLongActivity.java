...
public class AdditionalInfoLongActivity extends Activity{
	...
	private void createManufacturerList(){
		...
		final LinearLayout llVertical = new LinearLayout(AdditionalInfoLongActivity.this);
		llVertical.setOrientation(LinearLayout.VERTICAL);
		ListView listView = new ListView(AdditionalInfoLongActivity.this);
		
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(AdditionalInfoLongActivity.this,R.layout.list02, manufacturerList);
		...
		listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
				...
				manufacturer = item;
				Toast.makeText(AdditionalInfoLongActivity.this, item+getString(R.string.common_selected), Toast.LENGTH_SHORT).show();
				//選択した後、建築リストをクリアする 
				llVertical.removeAllViews();
					
				//show building in the layout
					
				TextView textView = new TextView(AdditionalInfoLongActivity.this);					
